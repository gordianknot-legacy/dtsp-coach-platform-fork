  ...
  return (
    <div className="space-y-5 max-w-4xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-lg font-semibold">Standards & Templates</h1>
        ...
        <Tabs defaultValue="thresholds">
          ...
          <TabsContent value="thresholds" className="mt-3">
            <div className="rounded-lg border border-border p-4 space-y-4">
              <p className="text-sm font-medium">Escalation & program thresholds</p>
              {[
          ...
          <TabsContent value="focus" className="mt-3">
            <div className="rounded-lg border border-border p-4 space-y-3">
              <p className="text-sm font-medium">Focus categories</p>
          ...
          {/* RUBRIC */}
          <TabsContent value="rubric" className="mt-3 space-y-3">
          ...
          {/* VBA CHECKLIST */}
          <TabsContent value="vba" className="mt-3">
            <div className="rounded-lg border border-border p-4 space-y-2">
              <p className="text-sm font-medium mb-1">VBA protocol checklist</p>
          ...
          <TabsContent value="required" className="mt-3">
            <div className="rounded-lg border border-border p-4 space-y-2">
              <p className="text-sm font-medium mb-1">Required fields before session close</p>
              {[
