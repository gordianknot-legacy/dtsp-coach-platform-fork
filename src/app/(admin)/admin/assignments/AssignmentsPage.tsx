      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="rounded-lg border border-border">
          <div className="px-3 py-2.5 border-b border-border">
            <p className="text-sm font-medium">Unassigned teachers ({unassignedTeachers.length})</p>
          </div>
          <div className="p-2 space-y-1 max-h-96 overflow-y-auto">
            {unassignedTeachers.length === 0 ? (
              <p className="text-sm text-muted-foreground py-4 text-center">All teachers are assigned.</p>
            ) : (
        ...
        <div className="rounded-lg border border-border">
          ...
          <div className="p-2 space-y-1 max-h-96 overflow-y-auto">
            {coachTeachers.length === 0 ? (
              <p className="text-sm text-muted-foreground py-4 text-center">No teachers assigned yet.</p>
            ) : (
              coachTeachers.map((t) => (
